...
class KeHoachBaoTriSearch extends KeHoachBaoTri
{
    ...
    public function rules()
    {
        return [
            ...
            [['ten_cong_viec', 'ngay_bao_tri_cuoi', 'can_cu', 'so_ky', 'ky_bao_tri', 'muc_do_uu_tien', 'don_vi_thoi_gian', 'dung_may', 'thue_ngoai', 'da_het_hieu_luc', 'ngay_het_hieu_luc', 'thoi_gian_tao'], 'safe'],
