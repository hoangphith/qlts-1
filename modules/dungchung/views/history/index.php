...
/* @var $searchModel app\modules\dungchung\models\HistorySearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Histories','class'=>'btn btn-outline-primary']).
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách Histories</em>',
