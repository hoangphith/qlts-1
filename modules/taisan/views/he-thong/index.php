...
/* @var $searchModel app\modules\taisan\models\HeThongSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới hệ thống','class'=>'btn btn-outline-primary']).
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách hệ thống</em>',
