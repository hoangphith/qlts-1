...
class ViTriController extends Controller
{
    ...
    /**
     * Updates an existing ViTri model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing ViTri model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ViTri model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the ViTri model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ViTri the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ViTri::findOne($id)) !== null) {
            return $model;
        } else {
