...
use app\modules\taisan\models\LoaiThietBiSearch;
...
/**
 * LoaiThietBiController implements the CRUD actions for LoaiThietBi model.
 */
class LoaiThietBiController extends Controller
{
    ...
    /**
     * Displays a single LoaiThietBi model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new LoaiThietBi model.
    ...
    /**
     * Updates an existing LoaiThietBi model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            *   Process for non-ajax request
            */
            if ($model->load($request->post()) && $model->Lưu()) {
                return $this->redirect(['view', 'id' => $model->id]);
            } else {
    ...
    /**
     * Delete an existing LoaiThietBi model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing LoaiThietBi model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the LoaiThietBi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LoaiThietBi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LoaiThietBi::findOne($id)) !== null) {
            return $model;
        } else {
