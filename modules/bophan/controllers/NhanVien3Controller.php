...
use app\modules\bophan\models\NhanVien3Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * NhanVien3Controller implements the CRUD actions for NhanVien model.
 */
class NhanVien3Controller extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    {
        $searchModel = new NhanVien3Search();
    ...
    {
        if (($model = NhanVien::findOne(['id' => $id])) !== null) {
            return $model;
        }
