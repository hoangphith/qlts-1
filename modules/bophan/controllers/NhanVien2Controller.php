...
use app\modules\bophan\models\NhanVien2Search;
...
/**
 * NhanVien2Controller implements the CRUD actions for NhanVien model.
 */
class NhanVien2Controller extends Controller
{
    /**
     * @inheritdoc
     */
