	...
	<div class="card-body">
		<div class="row">
			<div class="col-xl-6 pe-0">
				...
				<p class="mb-2 tx-12">
					<span class="tx-25 fw-500 lh-1 vertical-bottom mb-0">200</span>
					<span class="d-block tx-10 font-weight-semibold text-muted">Đang hoạt động</span>
				</p>
				<a href="#" class="tx-12 mb-0 text-secondary">Vào trang quản lý<i class="ti ti-chevron-right ms-1"></i></a>
			</div>
			<div class="col-xl-6">
