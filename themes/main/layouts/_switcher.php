					...
					<div class="predefined_styles">
						<!-- <div class="swichermainleft text-center">
							<div class="p-3 d-grid gap-2">
								...
								<a href="https://themeforest.net/user/spruko/portfolio" target="_blank"
									class="btn ripple btn-secondary">Our Portfolio</a>
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch25"
												id="switchbtn-ltr" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch25"
												id="switchbtn-rtl" class="onoffswitch2-checkbox">
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch15"
												id="switchbtn-vertical" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch15"
												id="switchbtn-horizontal" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch15"
												id="switchbtn-horizontalHover" class="onoffswitch2-checkbox">
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch1"
												id="switchbtn-light" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch1"
												id="switchbtn-dark" class="onoffswitch2-checkbox">
							...
							<div class="skin-body">
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<div class="">
											<input class="wd-30 h-30 input-color-picker color-primary-light"
												value="#150570" id="colorID" oninput="changePrimaryColor()" type="color"
												data-id="bg-color" data-id1="bg-hover" data-id2="bg-border"
												data-id3="transparentcolor" name="lightPrimary">
										</div>
									</div>
									<div class="switch-toggle d-flex mt-2">
										...
										<div class="">
											<input
												...
												value="#272145" id="transparentBgColorID" oninput="transparentBgColor()"
												type="color" data-id5="background" data-id6="white" data-id7="menu-bg"
												data-id8="header-bg" name="transparentBackground">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch2"
												id="switchbtn-lightmenu" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch2"
												id="switchbtn-colormenu" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch2"
												id="switchbtn-darkmenu" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch2"
												id="switchbtn-gradientmenu" class="onoffswitch2-checkbox">
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch3"
												id="switchbtn-lightheader" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch3"
												id="switchbtn-colorheader" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch3"
												id="switchbtn-darkheader" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch3"
												id="switchbtn-gradientheader" class="onoffswitch2-checkbox">
						...
						<div class="swichermainleft">
							...
							<div class="switch_section">
								<div class="switch-toggle d-flex">
									...
									<div class="onoffswitch2"><input type="radio" name="onoffswitchBody"
											id="switchbtn-shadow" class="onoffswitch2-checkbox" checked="">
										<label for="switchbtn-shadow" class="onoffswitch2-label"></label>
									</div>
								</div>
								<div class="switch-toggle d-flex">
									<span class="me-auto">No-shadow</span>
									<div class="onoffswitch2"><input type="radio" name="onoffswitchBody"
											id="switchbtn-noshadow" class="onoffswitch2-checkbox">
										<label for="switchbtn-noshadow" class="onoffswitch2-label"></label>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch4"
												id="switchbtn-fullwidth" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch4"
												id="switchbtn-boxed" class="onoffswitch2-checkbox">
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch5"
												id="switchbtn-fixed" class="onoffswitch2-checkbox" checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch5"
												id="switchbtn-scrollable" class="onoffswitch2-checkbox">
						...
						<div class="swichermainleft vertical-switcher">
							...
							<div class="skin-body">
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										<span class="me-auto">Defeult Menu</span>
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-defaultmenu" class="onoffswitch2-checkbox defeult-menu"
												checked>
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-closed" class="onoffswitch2-checkbox defeult-menu">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-text" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-overlay" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-hoversub" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-hoversub1" class="onoffswitch2-checkbox">
									...
									<div class="switch-toggle d-flex mt-2">
										...
										<p class="onoffswitch2 my-0"><input type="radio" name="onoffswitch6"
												id="switchbtn-doublemenu-tabs" class="onoffswitch2-checkbox">
