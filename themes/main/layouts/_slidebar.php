												...
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															<p class="mb-0 tx-medium text-truncate fs-15">Socrates
																Itumay</p>
															<span
																class="fs-11 text-muted text-truncate">(11)+390-2309</span>
														</div>
													</div>
											...
											<li class="px-0 py-2">
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															<p class="mb-0 tx-medium text-truncate fs-15">Reynante
																Labares</p>
															<span
																class="fs-11 text-muted text-truncate">(21)+326-1254</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
											...
											<li class="px-0 py-2">
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															<p class="mb-0 tx-medium text-truncate fs-15">Owen Bongcaras
															</p>
															<span
																class="fs-11 text-muted text-truncate">(54)+125-7861</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
											...
											<li class="px-0 py-2">
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															<p class="mb-0 tx-medium text-truncate fs-15">Mariane Galeon
															</p>
															<span
																class="fs-11 text-muted text-truncate">(14)+025-5621</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
												...
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															...
															<span
																class="fs-11 text-muted text-truncate">(11)+458-1205</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
											...
											<li class="px-0 py-2">
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															<p class="mb-0 tx-medium text-truncate fs-15">Sonia Fraser
															</p>
															<span
																class="fs-11 text-muted text-truncate">(21)+654-9517</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
												...
												<div class="d-flex align-items-start">
													<div
														...
														<div class="flex-grow-1">
															...
															<span
																class="fs-11 text-muted text-truncate">(14)+753-4268</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
													...
													<div
														...
														<div class="flex-grow-1">
															<p class="mb-0 tx-medium text-truncate fs-15">Reynante
																Labares</p>
															<span
																class="fs-11 text-muted text-truncate">(10)+111-1611</span>
														</div>
													</div>
													<a href="javascript:void(0);" class="mt-3 me-2">
														<i class="fe fe-edit fs-16"></i>
										...
										<div class="d-flex px-0 py-2">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted"> Hey! there I' am available....
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-16 me-2"><i
										...
										<div class="d-flex px-0 py-2">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted"> Okay...I will be waiting for you
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-16 me-2"><i
										...
										<div class="d-flex px-0 py-2">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted"> Hi we can explain our new
														Projects......
													</p>
												</a>
											</div>
								...
								<div class="tab-pane" id="tab3">
									<div class="list-group list-group-flush">
										<div class="d-flex px-0 py-2 ">
											...
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
													class="fe fe-x"></i></a>
										</div>
										<div class="d-flex px-0 py-2 ">
											<div class="me-2">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">At sanctus labore rebum stet sed
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">Sed amet stet clita dolores etc.,
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">Tempor justo ipsum clita rebum
														lorem.</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">You have Received Four files click
														to open</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">when an unknown printer took et.
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">remaining essentially It unchanged.
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">There are many variations of
														passages.</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
										...
										<div class="d-flex px-0 py-2 ">
											...
											<div class="">
												<a href="chat.html">
													...
													<p class="mb-0 fs-11 text-muted">Various versions have evolved over.
													</p>
												</a>
											</div>
											<a href="javascript:void(0);" class="ms-auto fs-13 mt-1"><i
