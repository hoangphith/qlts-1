	...
	<aside class="app-sidebar ps horizontal-main">
		...
		<div class="main-sidemenu">
			...
			<ul class="side-menu">
							...
							<div class="tab-menu-heading p-0 pb-2 border-0">
								<div class="tabs-menu ">
									<ul class="nav panel-tabs">
										...
										<li><a href="#side2" data-bs-toggle="tab"><i class="bi bi-box"></i>
												<p>Activity</p>
											</a></li>
									</ul>
								</div>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="side1">
										<ul class="sidemenu-list">
											...
											<li><a href="index.html" class="slide-item">Sales</a></li>
											<li><a href="index2.html" class="slide-item">Projects</a></li>
											<li><a href="index3.html" class="slide-item">Crypto</a></li>
											<li><a href="index4.html" class="slide-item">E Commerce</a></li>
											<li><a href="index5.html" class="slide-item">Analytics</a></li>
										</ul>
				...
				<li class="side-item side-item-category">Applications</li>
				...
				<li class="slide">
					<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
						...
						<span class="side-menu__label">Maps</span><i class="angle fe fe-chevron-right"></i>
					</a>
					<ul class="slide-menu">
						<li class="panel sidetab-menu">
							<div class="tab-menu-heading p-0 pb-2 border-0">
