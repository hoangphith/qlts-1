...
function index1(myVarVal) {
	chart.updateOptions({ colors: ["rgb(" + myVarVal + ")"], });
...
var ctx1 = document.getElementById('paidctchart').getContext('2d');
new Chart(ctx1, {
	type: 'bar',
	data: {
		labels: ['Date 1', 'Date 2', 'Date 3', 'Date 4', 'Date 5', 'Date 6', 'Date 7', 'Date 8', 'Date 9', 'Date 10', 'Date 11', 'Date 12', 'Date 13', 'Date 14', 'Date 15'],
...
function index11(myVarVal) {
	...
	var option3 = {
		...
		series: chartdata,
		color: [`rgb(${myVarVal})` ||'#17b794', 'rgba(246, 136, 95,0.8)']
	};
	var chart3 = document.getElementById('statistics');
