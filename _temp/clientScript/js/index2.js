function index2(myVarVal) {
	var options = {
	  ...
	  plotOptions: {
		candlestick: {
		  colors: {
			upward: 'rgba(246, 134, 106, 0.4)',
			downward: `rgb(${myVarVal})`|| "#4eb6d0"
		  },
		}
	  },
	};
	document.getElementById('cryptoReport').innerHTML = '';
	var chart = new ApexCharts(document.querySelector("#cryptoReport"), options);
	chart.render();
  }
...
// CHARTJS COST CHART CLOSED

// CHARTJS btc CHART  OPEN
...
// CHARTJS COST CHART  OPEN
var ctx1 = document.getElementById('ethData').getContext('2d');
new Chart(ctx1, {
	type: 'line',
	data: {
		labels: ['Date 1', 'Date 2', 'Date 3', 'Date 4', 'Date 5', 'Date 6', 'Date 7', 'Date 8', 'Date 9', 'Date 10', 'Date 11', 'Date 12', 'Date 13', 'Date 14', 'Date 15'],
